...
if ($claims['result'] == true) { // Token was OK
    ...
    if (connected($con, $response)) {
        ...
        $field2 = escape($con, 'field2', ''); if ($field2 == '') {$val2='';} else {$val2=$_POST['val2'];};
        $field3 = escape($con, 'field3', ''); if ($field3 == '') {$val3='';} else {$val3=$_POST['val3'];};
        $field4 = escape($con, 'field4', ''); if ($field4 == '') {$val4='';} else {$val4=$_POST['val4'];};
